...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isInputValid(address, detailAddress)) {
                    saveLocation(userID, address, detailAddress, latitude, longitude);
                }
            }
        });
    }

    private boolean isInputValid(String address, String addressDetail) {
        ...
        if (TextUtils.isEmpty(address) || TextUtils.isEmpty(addressDetail)) {
            ...
            if (TextUtils.isEmpty(addressDetail)) {
                tilAlamatDetail.setErrorEnabled(true);
                tilAlamatDetail.setError("Detail alamat harus diisi");
            }
    ...
    private void saveLocation(String userID, String alamat, String detailAlamat, double latitude, double longitude) {
        mapLaoding.show();
        ...
        databaseReference.child(userID).child(FDB_KEY_USER_ADDRESS).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                mapLaoding.dismiss();
                AddressModel result = dataSnapshot.getValue(AddressModel.class);
